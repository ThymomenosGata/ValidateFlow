...
[![](https://jitpack.io/v/ThymomenosGata/ValidateFlow.svg)](https://jitpack.io/#ThymomenosGata/ValidateFlow)
...
```kotlin
dependencies {
    implementation("com.github.ThymomenosGata:ValidateFlow:0.0.1")
}
```
